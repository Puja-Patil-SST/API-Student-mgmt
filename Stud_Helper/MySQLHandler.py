...
def insertJson(name, id, age):
    ...
    Sid = id
    Sage = age
    mycursor.execute("INSERT INTO Student (name,id,age) VALUES('"+Sname+"','"+Sid+"','"+Sage+"') ")
    mydb.commit()
    print(mycursor.rowcount,"record inserted")
...
def updateJson(id, name):
    mycursor=mydb.cursor()
    Sid= id
    up_nm=name
    mycursor.execute("UPDATE Student SET name='"+up_nm+"' where id='"+Sid+"' ")
    mydb.commit()
    print("Record Updated Successfully................")
